export const authErrors = {
  "auth/wrong-password": "La contraseña es incorrecta o este usuario no tiene contraseña.",
  ...
  "auth/too-many-requests":
    "Hemos bloqueado las peticiones desde este dispositivo debido ha actividad inusuarl. Intente de nuevo más tarde.",
  ...
  "auth/user-not-found": "Este usuario no existe o ha sido eliminado.",
  "auth/user-disabled": "The user account has been disabled by an administrator.",
  "auth/user-mismatch":
    "The supplied credentials do not correspond to the previously signed in user.",
  "auth/weak-password": "La contraseña debe contener 6 caracteres o más.",
